...
function placeXOrO(squareNumber) {
    ...
    function checkWinConditions() {
        ...
        else if (arrayIncludes ('6X', '6X', '8X')) { drawWinLine(50,508,558,508) }
        ...
        else if (arrayIncludes ('6O', '6O', '8O')) { drawWinLine(50,508,558,508) }
        ...
        function arrayIncludes(squareA, squareB, squareC) {
            ...
            //true is returned else if condition executes frawLine() function.
