...
const Calculator = {
    ...
    Display_Value: '0',
    //hold first operand for any expression, set null for now
    First_Operand: null,
    //checks if second operand has been inputted by the user
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //if operatore exists, property lookup is performed for the operator
